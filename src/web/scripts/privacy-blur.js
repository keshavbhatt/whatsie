...
// depends:  own <style>; structural anchors #pane-side, #main; message bubble
//           classes .message-in/.message-out (degrades to no-op if absent)
    ...
    function apply(level) {
        try {
            ...
            el.textContent =
                ...
                '#main .message-in:hover,#main .message-out:hover,' +
